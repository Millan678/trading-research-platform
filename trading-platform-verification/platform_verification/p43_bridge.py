"""Read-only bridge to Phase 43 — Statistical Validator."""
...
class Phase43Bridge:
    """Read-only adapter for Phase 43 (Statistical Validator). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 43
        self.package = "StatisticalValidator"
        self.description = "Statistical Validator"
