"""Read-only bridge to Phase 9 — Market Regime Detector."""
...
class Phase09Bridge:
    """Read-only adapter for Phase 9 (Market Regime Detector). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 9
        self.package = "MarketRegime"
        self.class_name = "MarketRegime"
        self.description = "Market Regime Detector"
