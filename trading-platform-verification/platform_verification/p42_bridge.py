"""Read-only bridge to Phase 42 — Bias Detector."""
...
class Phase42Bridge:
    """Read-only adapter for Phase 42 (Bias Detector). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 42
        self.package = "BiasDetector"
        self.description = "Bias Detector"
