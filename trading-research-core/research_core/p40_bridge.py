"""Read-only bridge to Phase 40 — Monte Carlo Engine."""
...
class Phase40Bridge:
    """Read-only adapter for Phase 40 (Monte Carlo Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 40
        self.package = "MonteCarloEngine"
        self.class_name = "MonteCarloEngine"
        self.description = "Monte Carlo Engine"
