"""Read-only bridge to Phase 23 — Social Cognition."""
...
class Phase23Bridge:
    """Read-only adapter for Phase 23 (Social Cognition). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 23
        self.package = "SocialCognition"
        self.description = "Social Cognition"
