"""Read-only bridge to Phase 5 — Portfolio Analyzer."""
...
class Phase05Bridge:
    """Read-only adapter for Phase 5 (Portfolio Analyzer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 5
        self.package = "PortfolioAnalyzer"
        self.class_name = "PortfolioAnalyzer"
        self.description = "Portfolio Analyzer"
