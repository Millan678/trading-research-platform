"""Read-only bridge to Phase 49 — Research Coordinator."""
...
class Phase49Bridge:
    """Read-only adapter for Phase 49 (Research Coordinator). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 49
        self.package = "ResearchCoordinator"
        self.class_name = "ResearchCoordinatorPlatform"
        self.description = "Research Coordinator"
