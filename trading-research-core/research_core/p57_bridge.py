"""Read-only bridge to Phase 57 — Research Observatory."""
...
class Phase57Bridge:
    """Read-only adapter for Phase 57 (Research Observatory). Never modifies source."""
    ...
    def __init__(self, storage: Storage, seed: int = 0):
        ...
        self.description = "Research Observatory"
