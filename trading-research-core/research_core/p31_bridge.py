"""Read-only bridge to Phase 31 — Market Microstructure."""
...
class Phase31Bridge:
    """Read-only adapter for Phase 31 (Market Microstructure). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 31
        self.package = "MarketMicrostructure"
        self.class_name = "MarketMicrostructure"
        self.description = "Market Microstructure"
