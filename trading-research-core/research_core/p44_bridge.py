"""Read-only bridge to Phase 44 — Meta Research Platform."""
...
class Phase44Bridge:
    """Read-only adapter for Phase 44 (Meta Research Platform). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 44
        self.package = "MetaResearch"
        self.class_name = "MetaResearchPlatform"
        self.description = "Meta Research Platform"
