"""Read-only bridge to Phase 26 — Risk Parity Engine."""
...
class Phase26Bridge:
    """Read-only adapter for Phase 26 (Risk Parity Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 26
        self.package = "RiskParity"
        self.class_name = "RiskParity"
        self.description = "Risk Parity Engine"
