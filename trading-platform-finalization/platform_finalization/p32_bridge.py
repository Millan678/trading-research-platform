"""Read-only bridge to Phase 32 — Backtest Framework."""
...
class Phase32Bridge:
    """Read-only adapter for Phase 32 (Backtest Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 32
        self.package = "BacktestFramework"
        self.description = "Backtest Framework"
