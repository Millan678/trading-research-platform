"""Read-only bridge to Phase 17 — Emotion Model."""
...
class Phase17Bridge:
    """Read-only adapter for Phase 17 (Emotion Model). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 17
        self.package = "EmotionModel"
        self.description = "Emotion Model"
