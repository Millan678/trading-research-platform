"""Read-only bridge to Phase 47 — Open Science."""
...
class Phase47Bridge:
    """Read-only adapter for Phase 47 (Open Science). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 47
        self.package = "OpenScience"
        self.description = "Open Science"
