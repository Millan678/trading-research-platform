"""Read-only bridge to Phase 24 — Correlation Engine."""
...
class Phase24Bridge:
    """Read-only adapter for Phase 24 (Correlation Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 24
        self.package = "CorrelationEngine"
        self.class_name = "CorrelationEngine"
        self.description = "Correlation Engine"
