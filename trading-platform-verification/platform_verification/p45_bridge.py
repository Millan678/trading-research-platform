"""Read-only bridge to Phase 45 — Scientific Governance."""
...
class Phase45Bridge:
    """Read-only adapter for Phase 45 (Scientific Governance). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 45
        self.package = "ScientificGovernance"
        self.description = "Scientific Governance"
