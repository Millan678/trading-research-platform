"""Read-only bridge to Phase 38 — Explainable AI Engine."""
...
class Phase38Bridge:
    """Read-only adapter for Phase 38 (Explainable AI Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 38
        self.package = "ExplainableAI"
        self.class_name = "ExplainableAI"
        self.description = "Explainable AI Engine"
