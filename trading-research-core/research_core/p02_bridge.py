"""Read-only bridge to Phase 2 — Risk Framework."""
...
class Phase02Bridge:
    """Read-only adapter for Phase 2 (Risk Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 2
        self.package = "RiskFramework"
        self.class_name = "RiskFramework"
        self.description = "Risk Framework"
