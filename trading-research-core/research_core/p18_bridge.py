"""Read-only bridge to Phase 18 — Model Registry."""
...
class Phase18Bridge:
    """Read-only adapter for Phase 18 (Model Registry). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 18
        self.package = "ModelRegistry"
        self.class_name = "ModelRegistry"
        self.description = "Model Registry"
