"""Read-only bridge to Phase 13 — Strategy Framework."""
...
class Phase13Bridge:
    """Read-only adapter for Phase 13 (Strategy Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 13
        self.package = "StrategyFramework"
        self.class_name = "StrategyFramework"
        self.description = "Strategy Framework"
