"""Read-only bridge to Phase 36 — Evidence Framework."""
...
class Phase36Bridge:
    """Read-only adapter for Phase 36 (Evidence Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 36
        self.package = "EvidenceFramework"
        self.description = "Evidence Framework"
