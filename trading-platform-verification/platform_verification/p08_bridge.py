"""Read-only bridge to Phase 8 — Cognition Layer."""
...
class Phase08Bridge:
    """Read-only adapter for Phase 8 (Cognition Layer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 8
        self.package = "CognitionLayer"
        self.description = "Cognition Layer"
