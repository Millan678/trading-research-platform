"""Read-only bridge to Phase 10 — Learning Layer."""
...
class Phase10Bridge:
    """Read-only adapter for Phase 10 (Learning Layer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 10
        self.package = "LearningLayer"
        self.description = "Learning Layer"
