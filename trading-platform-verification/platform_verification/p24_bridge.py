"""Read-only bridge to Phase 24 — Moral Reasoning."""
...
class Phase24Bridge:
    """Read-only adapter for Phase 24 (Moral Reasoning). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 24
        self.package = "MoralReasoning"
        self.description = "Moral Reasoning"
