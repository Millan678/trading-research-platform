"""Read-only bridge to Phase 23 — Regime Adaptation Engine."""
...
class Phase23Bridge:
    """Read-only adapter for Phase 23 (Regime Adaptation Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 23
        self.package = "RegimeAdaptation"
        self.class_name = "RegimeAdaptation"
        self.description = "Regime Adaptation Engine"
