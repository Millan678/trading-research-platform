"""Read-only bridge to Phase 29 — Order Flow Analysis."""
...
class Phase29Bridge:
    """Read-only adapter for Phase 29 (Order Flow Analysis). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 29
        self.package = "OrderFlow"
        self.class_name = "OrderFlow"
        self.description = "Order Flow Analysis"
