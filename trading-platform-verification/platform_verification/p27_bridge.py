"""Read-only bridge to Phase 27 — Ethical Governor."""
...
class Phase27Bridge:
    """Read-only adapter for Phase 27 (Ethical Governor). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 27
        self.package = "EthicalGovernor"
        self.description = "Ethical Governor"
