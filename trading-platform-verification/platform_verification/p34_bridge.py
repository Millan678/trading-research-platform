"""Read-only bridge to Phase 34 — Meta-Learning."""
...
class Phase34Bridge:
    """Read-only adapter for Phase 34 (Meta-Learning). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 34
        self.package = "MetaLearning"
        self.description = "Meta-Learning"
