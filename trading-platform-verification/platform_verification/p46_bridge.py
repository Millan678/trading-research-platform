"""Read-only bridge to Phase 46 — Research Ethics."""
...
class Phase46Bridge:
    """Read-only adapter for Phase 46 (Research Ethics). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 46
        self.package = "ResearchEthics"
        self.description = "Research Ethics"
