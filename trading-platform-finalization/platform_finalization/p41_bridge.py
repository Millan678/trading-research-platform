"""Read-only bridge to Phase 41 — Replication Engine."""
...
class Phase41Bridge:
    """Read-only adapter for Phase 41 (Replication Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 41
        self.package = "ReplicationEngine"
        self.description = "Replication Engine"
