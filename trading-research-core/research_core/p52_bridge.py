"""Read-only bridge to Phase 52 — Evidence Engine."""
...
class Phase52Bridge:
    """Read-only adapter for Phase 52 (Evidence Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 52
        self.package = "EvidenceEngine"
        self.class_name = "EvidenceEnginePlatform"
        self.description = "Evidence Engine"
