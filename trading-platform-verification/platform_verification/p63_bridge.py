"""Read-only bridge to Phase 63 — Platform Finalization."""
...
class Phase63Bridge:
    """Read-only adapter for Phase 63 (Platform Finalization). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 63
        self.package = "PlatformFinalization"
        self.description = "Platform Finalization"
