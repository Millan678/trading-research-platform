"""Read-only bridge to Phase 55 — Research Benchmark."""
...
class Phase55Bridge:
    """Read-only adapter for Phase 55 (Research Benchmark). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 55
        self.package = "ResearchBenchmark"
        self.class_name = "ResearchBenchmarkPlatform"
        self.description = "Research Benchmark"
