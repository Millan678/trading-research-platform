"""Read-only bridge to Phase 17 — Feature Engineering."""
...
class Phase17Bridge:
    """Read-only adapter for Phase 17 (Feature Engineering). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 17
        self.package = "FeatureEngine"
        self.class_name = "FeatureEngine"
        self.description = "Feature Engineering"
