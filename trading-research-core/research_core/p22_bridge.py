"""Read-only bridge to Phase 22 — Ensemble Framework."""
...
class Phase22Bridge:
    """Read-only adapter for Phase 22 (Ensemble Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 22
        self.package = "EnsembleFramework"
        self.class_name = "EnsembleFramework"
        self.description = "Ensemble Framework"
