"""Read-only bridge to Phase 14 — Central Executive."""
...
class Phase14Bridge:
    """Read-only adapter for Phase 14 (Central Executive). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 14
        self.package = "CentralExecutive"
        self.description = "Central Executive"
