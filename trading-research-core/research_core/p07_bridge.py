"""Read-only bridge to Phase 7 — Fundamental Analysis."""
...
class Phase07Bridge:
    """Read-only adapter for Phase 7 (Fundamental Analysis). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 7
        self.package = "FundamentalAnalysis"
        self.class_name = "FundamentalAnalysis"
        self.description = "Fundamental Analysis"
