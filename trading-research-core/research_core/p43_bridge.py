"""Read-only bridge to Phase 43 — AutoML Pipeline."""
...
class Phase43Bridge:
    """Read-only adapter for Phase 43 (AutoML Pipeline). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 43
        self.package = "AutoMLPipeline"
        self.class_name = "AutoMLPipeline"
        self.description = "AutoML Pipeline"
