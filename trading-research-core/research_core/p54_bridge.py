"""Read-only bridge to Phase 54 — Scientific Institution."""
...
class Phase54Bridge:
    """Read-only adapter for Phase 54 (Scientific Institution). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 54
        self.package = "ScientificInstitution"
        self.class_name = "ScientificInstitutionPlatform"
        self.description = "Scientific Institution"
