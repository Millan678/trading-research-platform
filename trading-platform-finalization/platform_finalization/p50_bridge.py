"""Read-only bridge to Phase 50 — Replication Crisis."""
...
class Phase50Bridge:
    """Read-only adapter for Phase 50 (Replication Crisis). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 50
        self.package = "ReplicationCrisis"
        self.description = "Replication Crisis"
