"""Read-only bridge to Phase 61 — Scientific Council."""
...
class Phase61Bridge:
    """Read-only adapter for Phase 61 (Scientific Council). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 61
        self.package = "ScientificCouncil"
        self.class_name = "ScientificCouncilPlatform"
        self.description = "Scientific Council"
