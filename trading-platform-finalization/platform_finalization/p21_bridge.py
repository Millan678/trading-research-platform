"""Read-only bridge to Phase 21 — Language Facility."""
...
class Phase21Bridge:
    """Read-only adapter for Phase 21 (Language Facility). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 21
        self.package = "LanguageFacility"
        self.description = "Language Facility"
