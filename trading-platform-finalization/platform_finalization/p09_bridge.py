"""Read-only bridge to Phase 9 — Action Layer."""
...
class Phase09Bridge:
    """Read-only adapter for Phase 9 (Action Layer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 9
        self.package = "ActionLayer"
        self.description = "Action Layer"
