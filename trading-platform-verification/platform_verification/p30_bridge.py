"""Read-only bridge to Phase 30 — Narrative Engine."""
...
class Phase30Bridge:
    """Read-only adapter for Phase 30 (Narrative Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 30
        self.package = "NarrativeEngine"
        self.description = "Narrative Engine"
