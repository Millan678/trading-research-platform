"""Read-only bridge to Phase 36 — Bayesian Inference Engine."""
...
class Phase36Bridge:
    """Read-only adapter for Phase 36 (Bayesian Inference Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 36
        self.package = "BayesianInference"
        self.class_name = "BayesianInference"
        self.description = "Bayesian Inference Engine"
