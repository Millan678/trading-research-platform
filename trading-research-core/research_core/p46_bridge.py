"""Read-only bridge to Phase 46 — Research Integrity."""
...
class Phase46Bridge:
    """Read-only adapter for Phase 46 (Research Integrity). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 46
        self.package = "ResearchIntegrity"
        self.class_name = "ResearchIntegrityPlatform"
        self.description = "Research Integrity"
