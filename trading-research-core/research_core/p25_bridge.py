"""Read-only bridge to Phase 25 — Factor Model."""
...
class Phase25Bridge:
    """Read-only adapter for Phase 25 (Factor Model). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 25
        self.package = "FactorModel"
        self.class_name = "FactorModel"
        self.description = "Factor Model"
