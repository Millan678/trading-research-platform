"""Read-only bridge to Phase 37 — Bayesian Engine."""
...
class Phase37Bridge:
    """Read-only adapter for Phase 37 (Bayesian Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 37
        self.package = "BayesianEngine"
        self.description = "Bayesian Engine"
