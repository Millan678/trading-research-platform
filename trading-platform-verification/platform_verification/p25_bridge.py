"""Read-only bridge to Phase 25 — Consciousness Core."""
...
class Phase25Bridge:
    """Read-only adapter for Phase 25 (Consciousness Core). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 25
        self.package = "ConsciousnessCore"
        self.description = "Consciousness Core"
