"""Read-only bridge to Phase 29 — Identity Core."""
...
class Phase29Bridge:
    """Read-only adapter for Phase 29 (Identity Core). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 29
        self.package = "IdentityCore"
        self.description = "Identity Core"
