"""Read-only bridge to Phase 3 — Data Pipeline."""
...
class Phase03Bridge:
    """Read-only adapter for Phase 3 (Data Pipeline). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 3
        self.package = "DataPipeline"
        self.class_name = "DataPipeline"
        self.description = "Data Pipeline"
