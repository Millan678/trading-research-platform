"""Read-only bridge to Phase 1 — Trading Engine."""
...
class Phase01Bridge:
    """Read-only adapter for Phase 1 (Trading Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 1
        self.package = "TradingEngine"
        self.description = "Trading Engine"
