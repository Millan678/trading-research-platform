"""Read-only bridge to Phase 40 — Experiment Runner."""
...
class Phase40Bridge:
    """Read-only adapter for Phase 40 (Experiment Runner). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 40
        self.package = "ExperimentRunner"
        self.description = "Experiment Runner"
