"""Read-only bridge to Phase 6 — Technical Analysis."""
...
class Phase06Bridge:
    """Read-only adapter for Phase 6 (Technical Analysis). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 6
        self.package = "TechnicalAnalysis"
        self.class_name = "TechnicalAnalysis"
        self.description = "Technical Analysis"
