"""Read-only bridge to Phase 7 — Perception Layer."""
...
class Phase07Bridge:
    """Read-only adapter for Phase 7 (Perception Layer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 7
        self.package = "PerceptionLayer"
        self.description = "Perception Layer"
