"""Read-only bridge to Phase 6 — Market Analyzer."""
...
class Phase06Bridge:
    """Read-only adapter for Phase 6 (Market Analyzer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 6
        self.package = "MarketAnalyzer"
        self.description = "Market Analyzer"
