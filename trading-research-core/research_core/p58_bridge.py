"""Read-only bridge to Phase 58 — Research Observatory v2."""
...
class Phase58Bridge:
    """Read-only adapter for Phase 58 (Research Observatory v2). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 58
        self.package = "ResearchObservatory"
        self.class_name = "ResearchObservatoryPlatform"
        self.description = "Research Observatory v2"
