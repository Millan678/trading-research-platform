"""Read-only bridge to Phase 20 — World Model."""
...
class Phase20Bridge:
    """Read-only adapter for Phase 20 (World Model). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 20
        self.package = "WorldModel"
        self.description = "World Model"
