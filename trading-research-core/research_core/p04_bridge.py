"""Read-only bridge to Phase 4 — Backtesting Engine."""
...
class Phase04Bridge:
    """Read-only adapter for Phase 4 (Backtesting Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 4
        self.package = "BacktestEngine"
        self.class_name = "BacktestEngine"
        self.description = "Backtesting Engine"
