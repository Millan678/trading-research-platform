"""Read-only bridge to Phase 21 — Hyperparameter Engine."""
...
class Phase21Bridge:
    """Read-only adapter for Phase 21 (Hyperparameter Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 21
        self.package = "HyperparameterEngine"
        self.class_name = "HyperparameterEngine"
        self.description = "Hyperparameter Engine"
