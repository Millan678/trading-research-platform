"""Read-only bridge to Phase 11 — Optimization Framework."""
...
class Phase11Bridge:
    """Read-only adapter for Phase 11 (Optimization Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 11
        self.package = "OptimizationFramework"
        self.class_name = "OptimizationFramework"
        self.description = "Optimization Framework"
