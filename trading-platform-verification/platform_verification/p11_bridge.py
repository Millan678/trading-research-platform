"""Read-only bridge to Phase 11 — Reflection Layer."""
...
class Phase11Bridge:
    """Read-only adapter for Phase 11 (Reflection Layer). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 11
        self.package = "ReflectionLayer"
        self.description = "Reflection Layer"
