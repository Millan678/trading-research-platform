"""Read-only bridge to Phase 19 — Walk-Forward Analysis."""
...
class Phase19Bridge:
    """Read-only adapter for Phase 19 (Walk-Forward Analysis). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 19
        self.package = "WalkForward"
        self.class_name = "WalkForward"
        self.description = "Walk-Forward Analysis"
