"""Read-only bridge to Phase 1 — Paper Trading Engine."""
...
class Phase01Bridge:
    """Read-only adapter for Phase 1 (Paper Trading Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 1
        self.package = "TradingPaperEngine"
        self.class_name = "TradingPaperEngine"
        self.description = "Paper Trading Engine"
