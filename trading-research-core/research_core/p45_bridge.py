"""Read-only bridge to Phase 45 — Reasoning Engine."""
...
class Phase45Bridge:
    """Read-only adapter for Phase 45 (Reasoning Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 45
        self.package = "ReasoningEngine"
        self.class_name = "ReasoningEnginePlatform"
        self.description = "Reasoning Engine"
