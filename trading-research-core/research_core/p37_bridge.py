"""Read-only bridge to Phase 37 — Causal Discovery."""
...
class Phase37Bridge:
    """Read-only adapter for Phase 37 (Causal Discovery). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 37
        self.package = "CausalDiscovery"
        self.class_name = "CausalDiscovery"
        self.description = "Causal Discovery"
