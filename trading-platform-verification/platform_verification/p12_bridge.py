"""Read-only bridge to Phase 12 — Meta-Cognition."""
...
class Phase12Bridge:
    """Read-only adapter for Phase 12 (Meta-Cognition). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 12
        self.package = "MetaCognition"
        self.description = "Meta-Cognition"
