"""Read-only bridge to Phase 16 — ML Pipeline."""
...
class Phase16Bridge:
    """Read-only adapter for Phase 16 (ML Pipeline). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 16
        self.package = "MLPipeline"
        self.class_name = "MLPipeline"
        self.description = "ML Pipeline"
