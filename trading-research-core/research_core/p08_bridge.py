"""Read-only bridge to Phase 8 — Sentiment Analysis."""
...
class Phase08Bridge:
    """Read-only adapter for Phase 8 (Sentiment Analysis). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 8
        self.package = "SentimentAnalysis"
        self.class_name = "SentimentAnalysis"
        self.description = "Sentiment Analysis"
