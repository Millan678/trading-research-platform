"""Read-only bridge to Phase 15 — Alpha Research."""
...
class Phase15Bridge:
    """Read-only adapter for Phase 15 (Alpha Research). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 15
        self.package = "AlphaResearch"
        self.class_name = "AlphaResearch"
        self.description = "Alpha Research"
