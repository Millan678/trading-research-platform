"""Read-only bridge to Phase 30 — Liquidity Engine."""
...
class Phase30Bridge:
    """Read-only adapter for Phase 30 (Liquidity Engine). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 30
        self.package = "LiquidityEngine"
        self.class_name = "LiquidityEngine"
        self.description = "Liquidity Engine"
