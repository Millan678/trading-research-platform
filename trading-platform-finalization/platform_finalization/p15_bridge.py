"""Read-only bridge to Phase 15 — Memory Subsystem."""
...
class Phase15Bridge:
    """Read-only adapter for Phase 15 (Memory Subsystem). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 15
        self.package = "MemorySubsystem"
        self.description = "Memory Subsystem"
