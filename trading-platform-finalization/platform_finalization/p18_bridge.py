"""Read-only bridge to Phase 18 — Behavior System."""
...
class Phase18Bridge:
    """Read-only adapter for Phase 18 (Behavior System). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 18
        self.package = "BehaviorSystem"
        self.description = "Behavior System"
