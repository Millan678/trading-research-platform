"""Read-only bridge to Phase 33 — Research Kernel."""
...
class Phase33Bridge:
    """Read-only adapter for Phase 33 (Research Kernel). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 33
        self.package = "ResearchKernel"
        self.description = "Research Kernel"
