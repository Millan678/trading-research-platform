"""Read-only bridge to Phase 35 — Reinforcement Learning."""
...
class Phase35Bridge:
    """Read-only adapter for Phase 35 (Reinforcement Learning). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 35
        self.package = "ReinforcementLearning"
        self.class_name = "ReinforcementLearning"
        self.description = "Reinforcement Learning"
