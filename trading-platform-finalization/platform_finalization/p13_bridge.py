"""Read-only bridge to Phase 13 — Attention Mechanism."""
...
class Phase13Bridge:
    """Read-only adapter for Phase 13 (Attention Mechanism). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 13
        self.package = "AttentionMechanism"
        self.description = "Attention Mechanism"
