"""Read-only bridge to Phase 28 — Multi-Asset Framework."""
...
class Phase28Bridge:
    """Read-only adapter for Phase 28 (Multi-Asset Framework). Never modifies source."""

    def __init__(self, storage: Storage, seed: int = 0):
        self.storage = storage
        self.rng = random.Random(seed)
        self.phase = 28
        self.package = "MultiAsset"
        self.class_name = "MultiAsset"
        self.description = "Multi-Asset Framework"
